...
namespace TAlex.MathCore.NumericalAnalysis.EquationSolvers
{
    ...
    /// algorithms for finding roots of nonlinear equations of a real variable.
    /// </summary>
    public abstract class EquationSolver
    {
        #region Fields

        private Function1Real _func;
        ...
        /// <summary>
        /// Initializes a new instance of the EquationSolver class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the EquationSolver class with the specified target function.
        /// </summary>
        /// <param name="function">A delegate that specifies the target function.</param>
        protected EquationSolver(Function1Real function)
        {
            _func = function;
        }

        /// <summary>
        /// Initializes a new instance of the EquationSolver class with the specified target function and tolerance.
        /// </summary>
        /// <param name="function">A delegate that specifies the target function.</param>
        ...
        /// tolerance must be non negative.
        /// </exception>
        protected EquationSolver(Function1Real function, double tolerance)
        {
            if (tolerance < 0.0)
