...
namespace TAlex.MathCore.NumericalAnalysis.EquationSolvers
{
    ...
    public class BisectionEquationSolver : RootBracketingEquationSolver
    {
        ...
        public BisectionEquationSolver(Function1Real function, double lowerBound, double upperBound)
        ...
        /// </exception>
        public BisectionEquationSolver(Function1Real function, double lowerBound, double upperBound, double tolerance)
