...
namespace TAlex.MathCore.UnitConversion.Quantities
{
    public class Weight : Quantity
    {
        ...
        public static readonly LinearUnit ShortTon = new LinearUnit("Short ton (US)", "Short tons (US)", "short ton", 907.18474M);
        public static readonly LinearUnit LongTon = new LinearUnit("Long ton", "Long tons (UK)", "long ton", 1016.0469088M);
