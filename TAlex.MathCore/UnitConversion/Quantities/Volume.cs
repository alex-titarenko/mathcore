...
namespace TAlex.MathCore.UnitConversion.Quantities
{
    public class Volume : Quantity
    {
        ...
        public static readonly LinearUnit FluidOunceUS = new LinearUnit("Ounce (US)", "Ounces (US)", "US fl oz", 0.0000295735295625M);
        ...
        public static readonly LinearUnit FluidOunceUK = new LinearUnit("Ounce (UK)", "Ounces (UK)", "UK fl oz", 0.0000284130625M);
