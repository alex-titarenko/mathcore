...
namespace TAlex.MathCore.NumericalAnalysis.EquationSolvers
{
    ...
    public class BrentEquationSolver : RootBracketingEquationSolver
    {
        ...
        public BrentEquationSolver(Func<double, double> function, double lowerBound, double upperBound)
        ...
        /// </exception>
        public BrentEquationSolver(Func<double, double> function, double lowerBound, double upperBound, double tolerance)
